...
<head>
    ...
    <link rel="stylesheet" href="<?=$assets?>pos/css/bootstrap-responsive.css" type="text/css"/>
...
<div id="wrapper">
    <header id="header" class="navbar">
        <div class="container">
            <a class="navbar-brand hidden-sm" href="<?=admin_url()?>"><span class="logo"><span class="pos-logo-lg"><?=$Settings->site_name?></span><span class="pos-logo-sm"><?=lang('pos')?></span></span></a>
                        ...
                        <div id="left-top">
                            ...
                            <div class="form-group">
                                ...
                                ?>
                                    ...
                                    <div class="input-group-addon no-print" style="padding: 2px 8px; border-left: 0;">
                                        <a href="<?=admin_url('customers/scancustomer'); ?>" id="scan-customer" class="external" data-toggle="modal" data-target="#myModal">
                                            <i class="fa fa-qrcode" id="addIcon" style="font-size: 1.2em;"></i>
                                        </a>
                                    </div>
...
<div class="hidden-phone rotate btn-cat-con">
            ...
            foreach ($billers as $biller) {
                ...
                if ($biller->id == $this->session->userdata('biller_id')) {
                    ...
                    <div class="col-md-2 col-sm-3 text-center" style="padding-left: 0;">
                        <span style="font-size: 1em; font-weight: bold;"><?=lang('quick_cash');?></span>
...
<script type="text/javascript">
    ...
    function widthFunctions(e) {
        ...
        $('#left-middle').css("min-height", 110);
        $('#product-list').css("height", wh - lth - lbh - 107);
        $('#product-list').css("min-height", 110);
    }
